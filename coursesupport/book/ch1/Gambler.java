...
public class Gambler { 
    ...
    public static void main(String[] args) {
        ...
        int stake = ap.nextInt("What is the gambler's stated bankroll?");
        int goal = ap.nextInt("What is the gambler's stated goal?");
        int T = ap.nextInt("What is the number of trials to run?");    // number of trials to perform
